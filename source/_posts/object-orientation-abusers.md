...
{% asset_img oo-abusers.png oo-abusers %}
...
{% asset_img switch-statements-01.png switch-statements-01 %}
...
{% asset_img switch-statements-02.png switch-statements-02 %}
...
{% asset_img move-method-before.png move-method-before %}

**解决**

在该函数最常引用的类中建立一个有着类似行为的新函数。将旧函数变成一个单纯的委托函数，或是旧函数完全移除。

{% asset_img move-method-after.png move-method-after %}
...
{% asset_img temporary-field-01.png temporary-field-01 %}
...
{% asset_img temporary-field-02.png temporary-field-02 %}

### 收益

- 更好的代码清晰度和组织性。

{% asset_img temporary-field-03.png temporary-field-03 %}
...
{% asset_img refused-bequest-01.png refused-bequest-01 %}
...
{% asset_img refused-bequest-02.png refused-bequest-02 %}

### 收益

- 提高代码的清晰度和组织性。

{% asset_img refused-bequest-03.png refused-bequest-03 %}
...
{% asset_img replace-inheritance-with-delegation-before.png replace-inheritance-with-delegation-before %}
...
{% asset_img replace-inheritance-with-delegation-after.png replace-inheritance-with-delegation-after %}
...
{% asset_img extract-superclass-before.png extract-superclass-before %}

**解决**

为这两个类建立一个超类，将相同特性移至超类。

{% asset_img extract-superclass-after.png extract-superclass-after %}

## 异曲同工的类

两个类中有着不同的函数，却在做着同一件事。

{% asset_img alternative-classes-with-different-interfaces-01.png alternative-classes-with-different-interfaces-01 %}
...
{% asset_img alternative-classes-with-different-interfaces-02.png alternative-classes-with-different-interfaces-02 %}
...
{% asset_img parameterize-method-before.png parameterize-method-before %}

**解决**

建立单一函数，以参数表达哪些不同的值。

{% asset_img parameterize-method-after.png parameterize-method-after %}
...
- [代码坏味道系列之膨胀剂](https://komamj.github.io/2020/02/17/bloaters/)
